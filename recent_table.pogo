...
<table class="table table-striped">
   <thead>
      <tr>
         <th>First Name
            <%= psp_sort_arrow('p_publish=sortRecent&p_sort=' || p_sort || '&p_column=first_name', CU) %>
         </th>
         <th>Last Name
            <%= psp_sort_arrow('p_publish=sortRecent&p_sort=' || p_sort || '&p_column=last_name', CU) %>
        </th>
         <th>Email
            <%= psp_sort_arrow('p_publish=sortRecent&p_sort=' || p_sort || '&p_column=email', CU) %>
        </th>
      </tr>
   </thead>
<%
